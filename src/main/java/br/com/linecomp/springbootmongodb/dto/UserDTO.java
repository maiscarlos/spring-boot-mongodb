...
package br.com.linecomp.springbootmongodb.dto;

import java.io.Serializable;

import br.com.linecomp.springbootmongodb.domain.User;

public class UserDTO implements Serializable { // dto são utilizado para requisitar nao todos os dados
	...
	public UserDTO(User obj) { // no construtor já recebe um objeto user
		id = obj.getId();
		name = obj.getName();
		email = obj.getEmail();
	}
